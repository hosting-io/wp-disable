...
class Folium_UI {
	...
	/**
	 * Data-URI menu icon (Folium chat mark). Single-colour; WP tints it.
	 *
	 * @return string
	 */
	private static function menu_icon() {
		$svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#a7aaad" d="M12 3C6.5 3 2 6.9 2 11.8c0 2.5 1.2 4.7 3.1 6.3L4.2 21.7l3.9-1.9c1.2.4 2.5.6 3.9.6 5.5 0 10-3.9 10-8.8S17.5 3 12 3z"/></svg>';
